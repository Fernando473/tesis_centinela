...
Para este sprint, hemos seleccionado las Historias de Usuario enfocadas principalmente en la integración gráfica de las plataformas mencionadas en la sección \ref{chapter01-section03:ResNet}, que se muestran en la tabla \ref{C2T1:Historias de Usuario del Sprint 1}. 
...
\input{../03Tables/02Chapter/C2T1_huSprint1.tex}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../02Figures/02Chapter/Sprints/Sprint-1/fig_azure-board-sprint-1.png}
...
La página de resultados es la pantalla que se mostrará al usuario después de realizar una búsqueda.
En esta pantalla, se mostrarán los resultados de la búsqueda, que incluirán una lista de autores y artículos relevantes.
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{../02Figures/02Chapter/Sprints/Sprint-1/mobile-first-results.png}
